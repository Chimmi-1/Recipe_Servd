        ...
        <Card className="rounded-none overflow-hidden border-stone-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group pt-0">
            {data.showImage ? (
              ...
              <div className="absolute inset-0 bg-linear-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <CardHeader>
              <CardTitle className="text-lg font-bold text-stone-900 group-hover:text-orange-600 
              transition-colors lone-clamp-2">
                {data.title}
              </CardTitle>
              </CardHeader>
...
if(variant == "list"){
  return(
  <Link href={data.href}>
    <Card className="rounded-none border-stone-200 hover:shadow-lg hover:border-orange-200
    transition-all cursor-pointer group overflow-hidden py-0">
         ...
         {/* Image (if available) */}
            ...
            <div className="flex-1 py-5">
              <CardHeader>
                ...
                <CardTitle className="text-xl font-bold text-stone-900 group-hover:text-orange-600
                transition-colors">
                  {data.title}
                </CardTitle>
