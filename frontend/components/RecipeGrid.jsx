...
import { ArrowLeft, Loader2 } from 'lucide-react'; // Remove 'Link' from here
import Link from 'next/link'; // Import Link from Next.js instead
...
useEffect(()=>{
    if(value){
        ...
        fetchMeals(formatedValue);
    }
}, [value]);

const meals = data?.meals || [];
const displayName = value?.replace(/-/g, " "); //convert "saudi-arabian" to "saudi arabina"



  return (<div className="min-h-screen bg-stone-50 pt-20 pb-16 px-4">
    <div className="container mx-auto max-w-7xl">
        <div className="mb-8">
            <Link
            href={backLink}
            className="inline-flex items-center gap-2 text-stone-600
            hover:text-orange-600 transition-colors mb-4">
         ...
         text-stone-900 capitalize tracking-tight leading-tight">
            {displayName}{" "}
