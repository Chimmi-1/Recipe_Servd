...
import { Flame, ArrowRight, Star,Users,Clock } from "lucide-react";
...
<div key={i}>
  ...
  className="bg-transparent text-orange-500 text-sm uppercase
...
<div className="grid md:grid-cols-2 gap-6">
  {FEATURES.map((feature, i) =>{
    ...
    return (
      <Card 
      key={i}
      className="border-2 border-stone-200 bg-white
      hover:border-orange-600 hover:shadow-lg transition-all group py-0">
