...
import { getOrGenerateRecipe, removeReccipeFromCollection, saveRecipeToCollection } from '@/actions/recipe.actions';
import { Button } from '@/components/ui/button';
import useFetch from '@/hooks/use-fetch';
import { AlertCircle, ArrowLeft, Bookmark, BookmarkCheck, CheckCircle2, ChefHat, Clock, Download, Flame, Lightbulb, Loader2, Users } from 'lucide-react';
...
}=useFetch(removeReccipeFromCollection);
...
<div className="bg-orange-50 w-20 h-20 border-2 border-orange-200 flex items-center justfify-center
mx-auto mb-6">
...
if(loadingRecipe === false && !recipe){
 return( <div className="min-h-screen bg-stone-50 pt-24 pb-16">
<div className="container mx-auto max-w-4xl text-center py-20">
  <div className="bg-red-50 w-20 h-20 border-2 border-red-200 flex
  ...
  <p className="text-stone-600 mb-6 font-light">
    Something went wromng while loading the recipe. Please try again.
  </p>
...
<div className="mb-8">
  <Link
   ...
   hover:text-orange-600 transition-colors mb-6 font-medium">
...
{/* Description */}
<p className="texxt-lg text-stone-600 mb-6 font-light">
  {recipe.description}
</p>
...
``` */}
{/* 
How to write this code to be free */}
